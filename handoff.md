# Handoff — agent-dev-landing

更新时间：2026-08-08

## 项目概况
AgentDev 产品落地页。Astro 7 静态站点，中英双语，部署于 Cloudflare Pages。
通过页头/页脚链接回 hub 站 bayjf.com，不与其他落地页直接互链。

## 已完成（本地未推送，分支 dev）
- `0554b2c` feat(legal): add privacy, terms and 404 pages
- `2cbbb61` feat(seo): add bilingual OG social share images
...
- hub 站 bayjf 的产品卡片引用本站的 `https://agent-dev-landing.pages.dev/preview.png` 作为封面。
